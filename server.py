...
It uses the 'emotion_detector' and 'emotion_predictor' functions
from the EmotionDetection package to analyze text and determine
the dominant emotion.

The application provides a web interface where users can input
text, and the server will respond with the detected emotions.

Dev by: EMIR AFIQ RIDZUAN
"""
